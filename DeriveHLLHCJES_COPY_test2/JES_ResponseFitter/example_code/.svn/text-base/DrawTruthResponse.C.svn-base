...
int main() {
  ...
  TFile *file = TFile::Open("example_code/Pythia_EM_LC_correctPythiaDijets_OriginalBinning_ResponseHistograms.root");
  ...
  for (int ei=0;ei<etaBins.size();++ei) {
