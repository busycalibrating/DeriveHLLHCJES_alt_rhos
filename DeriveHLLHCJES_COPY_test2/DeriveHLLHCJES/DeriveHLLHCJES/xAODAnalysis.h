#ifndef DeriveHLLHCJES__xAODAnalysis_H
#define DeriveHLLHCJES__xAODAnalysis_H
...
class xAODAnalysis : public EL::Algorithm
{
    ...
    TH1F *h_events; //!
    TH1F *h_ev_LC_cutFlow; //!
    TH1F *h_ev_EM_cutFlow; //!
    TH1F *h_ev_10_cutFlow; //!
    TH1F *h_jet_EM_cutFlow; //!
    TH1F *h_jet_LC_cutFlow; //!
    TH1F *h_10jet_cutFlow; //!
    TH1F *h_jet_T_LC_cutFlow; //!
    TH1F *h_jet_T_EM_cutFlow; //!
    TH1F *h_10jet_T_cutFlow; //!
    ...
    xAODAnalysis();
    xAODAnalysis (string config, string JESconfigfile);
    ...
    void ev_ControlCut(TString jetAlgo, int i);
    void jet_ControlCut(TString jetAlgo, int i);
    void jet_T_ControlCut(TString jetAlgo, int i);
    void ev_LC_cutFlow (int i);
    void ev_EM_cutFlow (int i);
    void ev_10_cutFlow (int i);
    void jet_LC_cutFlow (int i);
    void jet_EM_cutFlow (int i);
    void Fatjet_cutFlow (int i);
    void jet_Truth_EM_cutFlow (int i);
    void jet_Truth_LC_cutFlow (int i);
    void Fatjet_Truth_cutFlow (int i);
