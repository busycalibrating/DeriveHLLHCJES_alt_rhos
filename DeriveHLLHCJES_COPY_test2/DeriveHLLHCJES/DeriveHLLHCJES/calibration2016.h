...
class calibration2016 : public EL::Algorithm
{
    ...
    bool do_reclustering; //!
    //fastjet::JetAlgorithm recomb_algo; //!
    double jet_R; //!

    ///////////////////////////////////////////////////////////////////////////ddobre::20.02.17
    // ALTERNATE RHO CALCULATION PARAMETERS

    VecD m_Strip_DeltaMax; //!
    VecD m_Circle_DeltaMax; //!
    VecD m_Doughnut_DeltaMin; //!
    VecD m_Doughnut_DeltaMax; //!

    StrV RHOSTRIP_ranges; //!
    StrV RHOCIRCLE_ranges; //!
    StrV RHODOUGHNUT_ranges; //!
