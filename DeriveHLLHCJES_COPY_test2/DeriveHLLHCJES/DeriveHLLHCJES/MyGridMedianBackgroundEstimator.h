#ifndef __MYGRID_MEDIAN_BACKGROUND_ESTIMATOR_HH__
#define __MYGRID_MEDIAN_BACKGROUND_ESTIMATOR_HH__

//STARTHEADER
// $Id: MyGridMedianBackgroundEstimator.h 323529 2016-06-20 20:28:30Z alkire $
//
...
///
class MyGridMedianBackgroundEstimator : public BackgroundEstimatorBase {
public:
  ...
  MyGridMedianBackgroundEstimator(double ymax, double requested_grid_spacing) :
    _ymin(0.), _ymax(ymax), 
    _requested_grid_spacing(requested_grid_spacing),
    _has_particles(false){setup_grid();}
  //\}
  MyGridMedianBackgroundEstimator(double ymin,double ymax, double requested_grid_spacing) :
