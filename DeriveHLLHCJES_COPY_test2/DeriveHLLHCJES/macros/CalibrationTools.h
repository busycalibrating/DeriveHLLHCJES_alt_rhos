...
void JetPileupCorrection(float &pt, float &eta, float &phi, float &e, float &m, TLorentzVector &jet_calo, TLorentzVector &jet_origin, float AREA, float RHO, float offsetET, bool saveNegative=true){
  ...
  /////////
  //std::cout<< "==================================================" << std::endl;
  //std::cout<< "               JetPileupCorrection" << std::endl;
  //std::cout<< "pt   e    m    eta   phi " <<std::endl;
  //std::cout<< pt << " " << e << " " << m << " " << eta << " " << phi << std::endl;
  //std::cout<<" area, rho, offsetET " <<std::endl;
  //std::cout<< AREA << " " << RHO << " " << offsetET << " " << std::endl;
  //std::cout<< "pileup scalefactors" <<std::endl;
  //std::cout<< pileup_SF << std::endl;
  //////////
